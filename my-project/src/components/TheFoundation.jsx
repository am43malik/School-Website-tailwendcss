...
const TheFoundation = () => {
  return (
    <div>
        <h3  className='text-lg md:text-xl font-bold text-center text-blue-900 mt-5'>THE PRIMARY SCHOOL
I TO IV</h3>
      <p  className='text-gray-500 md:px-5 text-lg text-left mt-2'>THE FOUNDATION YEARS PROGRAMME (The Primary School) encourages inquiry and exploration, and develops children's competence in various skills reading, writing, listening, speaking, problem-solving, observation, measurement and use of information and communications technology.
